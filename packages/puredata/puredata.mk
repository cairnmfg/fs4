...
PUREDATA_CONF_OPTS = --disable-portaudio --disable-portmidi --no-recursion --disable-jack --disable-jack-framework --without-local-portmidi --disable-oss --without-local-portaudio
